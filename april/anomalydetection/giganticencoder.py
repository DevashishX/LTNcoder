...
ltn_rows_file = 'gigantic_ltn_rows.pkl'
gigantic_ltn_class_row_values = [10, 25] + list(range(50, 301, 50))
# gigantic_ltn_class_row_values = [10, 25]
gigantic_ltn_row_classes = []
gigantic_leaky_class_row_values = [10, 25] + list(range(50, 301, 50))
# gigantic_leaky_class_row_values = [10, 25]
gigantic_leaky_row_classes = []

class GiganticDAE(NNAnomalyDetector):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'giganticdae'
    name = f'GiganticDAE'
    ...
    def __init__(self, model=None):
        ...
        super(GiganticDAE, self).__init__(model=model)
...
class GiganticLTN(NNAnomalyDetector):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'Giganticltn'
    name = f'GiganticLTN'
    ...
    def __init__(self, model=None):
        super(GiganticLTN, self).__init__(model=model)
...
class GiganticLTNFROZEN(GiganticLTN):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'giganticltnfrozen'
    name = f'GiganticLTNFROZEN'

    def __init__(self, model=None):
        super(GiganticLTNFROZEN, self).__init__(model=model)
...
def create_ltn_classes(base_class, row_values, target_module):
    for rows in row_values:
        ...
        gigantic_ltn_row_classes.append(new_class)
...
def create_leaky_classes(base_class, leaky_values, target_module):
    for leaky in leaky_values:
        ...
        setattr(target_module, class_name, new_class)  # Register to actual module
        gigantic_leaky_row_classes.append(new_class)
# Create and register the classes
create_ltn_classes(GiganticLTNFROZEN, gigantic_ltn_class_row_values, sys.modules[__name__])
create_leaky_classes(GiganticDAE, gigantic_leaky_class_row_values, sys.modules[__name__])