...
ltn_rows_file = 'medium_ltn_rows.pkl'
medium_ltn_class_row_values = [10, 25] + list(range(50, 351, 50))
# medium_ltn_class_row_values = [10, 25]
medium_ltn_row_classes = []
medium_leaky_class_row_values = [10, 25] + list(range(50, 351, 50))
# medium_leaky_class_row_values = [10, 25]
medium_leaky_row_classes = []

class MediumDAE(NNAnomalyDetector):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'mediumdae'
    name = f'MediumDAE'
    ...
    def __init__(self, model=None):
        ...
        super(MediumDAE, self).__init__(model=model)
...
class MediumLTN(NNAnomalyDetector):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'Mediumltn'
    name = f'MediumLTN'
    ...
    def __init__(self, model=None):
        super(MediumLTN, self).__init__(model=model)
...
class MediumLTNFROZEN(MediumLTN):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'mediumltnfrozen'
    name = f'MediumLTNFROZEN'

    def __init__(self, model=None):
        super(MediumLTNFROZEN, self).__init__(model=model)
...
def create_ltn_classes(base_class, row_values, target_module):
    for rows in row_values:
        ...
        medium_ltn_row_classes.append(new_class)
...
def create_leaky_classes(base_class, leaky_values, target_module):
    for leaky in leaky_values:
        ...
        setattr(target_module, class_name, new_class)  # Register to actual module
        medium_leaky_row_classes.append(new_class)
# Create and register the classes
create_ltn_classes(MediumLTNFROZEN, medium_ltn_class_row_values, sys.modules[__name__])
create_leaky_classes(MediumDAE, medium_leaky_class_row_values, sys.modules[__name__])