...
class P2pDAE(NNAnomalyDetector):
    ...
    def __init__(self, model=None):
        ...
        super(P2pDAE, self).__init__(model=model)
...
class P2pLTN(NNAnomalyDetector):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'P2pltn'
    name = f'P2pLTN'
    ...
    def __init__(self, model=None):
        super(P2pLTN, self).__init__(model=model)
...
class P2pLTNFROZEN(P2pLTN):
    """Implements a denoising autoencoder based anomaly detection algorithm."""

    abbreviation = f'p2pltnfrozen'
    name = f'P2pLTNFROZEN'

    def __init__(self, model=None):
        super(P2pLTNFROZEN, self).__init__(model=model)
...
def create_ltn_classes(base_class, row_values, target_module):
    for rows in row_values:
        ...
        p2p_ltn_row_classes.append(new_class)
...
def create_leaky_classes(base_class, leaky_values, target_module):
    for leaky in leaky_values:
        ...
        setattr(target_module, class_name, new_class)  # Register to actual module
        p2p_leaky_row_classes.append(new_class)
# Create and register the classes
create_ltn_classes(P2pLTNFROZEN, p2p_ltn_class_row_values, sys.modules[__name__])
create_leaky_classes(P2pDAE, p2p_leaky_class_row_values, sys.modules[__name__])